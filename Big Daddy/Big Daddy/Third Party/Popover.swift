...
open class Popover: UIView {
  ...
  open var cornerRadiuss: CGFloat = 6.0
  ...
  open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
    ...
    self.contentView.layer.cornerRadius = self.cornerRadiuss
  ...
  override open func draw(_ rect: CGRect) {
    ...
    case .up:
      ...
      arrow.addLine(to: CGPoint(x: self.cornerRadiuss, y: self.bounds.height - self.arrowSize.height))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.cornerRadiuss,
          y: self.bounds.height - self.arrowSize.height - self.cornerRadiuss
        ),
        radius: self.cornerRadiuss,
        startAngle: self.radians(90),
        endAngle: self.radians(180),
        clockwise: true)

      arrow.addLine(to: CGPoint(x: 0, y: self.cornerRadiuss))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.cornerRadiuss,
          y: self.cornerRadiuss
        ),
        radius: self.cornerRadiuss,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiuss, y: 0))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiuss,
          y: self.cornerRadiuss
        ),
        radius: self.cornerRadiuss,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.cornerRadiuss))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiuss,
          y: self.bounds.height - self.arrowSize.height - self.cornerRadiuss
    ...
    case .down, .auto:
      ...
      if self.isCloseToCornerRightArrow && !self.isCornerRightArrow {
        if !isBehindCornerRightArrow {
          arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiuss, y: self.arrowSize.height))
          arrow.addArc(
            withCenter: CGPoint(x: self.bounds.width - self.cornerRadiuss, y: self.arrowSize.height + self.cornerRadiuss),
            radius: self.cornerRadiuss,
            startAngle: self.radians(270.0),
            endAngle: self.radians(0),
            clockwise: true)
        } else {
          arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.arrowSize.height + self.cornerRadiuss))
        ...
        arrow.addArc(
          withCenter: CGPoint(
            x: self.bounds.width - self.cornerRadiuss,
            y: self.arrowSize.height + self.cornerRadiuss
          ),
          radius: self.cornerRadiuss,
          startAngle: self.radians(270.0),
          endAngle: self.radians(0),
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.cornerRadiuss))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiuss,
          y: self.bounds.height - self.cornerRadiuss
        ),
        radius: self.cornerRadiuss,
        startAngle: self.radians(0),
        endAngle: self.radians(90),
      ...
      arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.cornerRadiuss))
    ...
    case .left:
        ...
        arrow.addLine(to: CGPoint(x:self.bounds.width - self.arrowSize.height, y: self.bounds.height - self.cornerRadiuss))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width - self.arrowSize.height - self.cornerRadiuss,
                y: self.bounds.height - self.cornerRadiuss
            ),
            radius: self.cornerRadiuss,
        ...
        arrow.addLine(to: CGPoint(x: self.cornerRadiuss, y: self.bounds.height))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.cornerRadiuss,
                y: self.bounds.height - self.cornerRadiuss
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width - self.arrowSize.height - self.cornerRadiuss, y: 0))
        arrow.addArc(
            withCenter: CGPoint(x: self.bounds.width - self.arrowSize.height - self.cornerRadiuss,
                                y: self.cornerRadiuss
            ),
            radius: self.cornerRadiuss,
            startAngle: self.radians(270),
    ...
    case .right:
        ...
        arrow.addArc(
            withCenter: CGPoint(
                x: arrowPoint.x + self.arrowSize.height + self.cornerRadiuss,
                y: self.bounds.height - self.cornerRadiuss
            ),
            radius: self.cornerRadiuss,
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x - self.cornerRadiuss, y: self.bounds.height))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width + arrowPoint.x - self.cornerRadiuss,
                y: self.bounds.height - self.cornerRadiuss
            ),
            radius: self.cornerRadiuss,
            startAngle: self.radians(90),
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x, y: self.cornerRadiuss))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width + arrowPoint.x - self.cornerRadiuss,
                y: self.cornerRadiuss
        ...
        arrow.addLine(to: CGPoint(x: arrowPoint.x + self.arrowSize.height - self.cornerRadiuss, y: 0))
        arrow.addArc(
            withCenter: CGPoint(x: arrowPoint.x + self.arrowSize.height + self.cornerRadiuss,
                                y: self.cornerRadiuss
            ),
            radius: self.cornerRadiuss,
            startAngle: self.radians(-90),
