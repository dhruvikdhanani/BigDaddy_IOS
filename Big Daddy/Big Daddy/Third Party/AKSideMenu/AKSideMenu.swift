...
open class AKSideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    override open func viewDidLoad() {
        ...
        if let contentViewController = self.contentViewController {
            ...
            let backView = UIView()
            backView.frame = CGRect(x: contentViewController.view.frame.minX-44, y: contentViewController.view.frame.minY+64, width: contentViewController.view.frame.width, height: contentViewController.view.frame.height-128)
            backView.cornerRadius = 16
            backView.backgroundColor = .themeLightColor
            self.contentViewContainer.addSubview(backView)
            backView.sendSubviewToBack(self.contentViewContainer)
    ...
    func showLeftMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: { [self] in
            if self.scaleContentView {
                ...
                self.contentViewContainer.cornerRadius = 24
            } else {
    ...
    func showRightMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
            if self.scaleContentView {
                ...
                self.contentViewContainer.transform = .identity
                self.contentViewContainer.cornerRadius = 0
            }
    ...
    func hideMenuViewControllerAnimated(_ animated: Bool) {
        ...
        contentViewContainer.cornerRadius = 0
